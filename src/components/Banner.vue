<template>
  <div class="banner-content border-b-2" id="home">
    <div class="w-full md:px-64 md:mx-auto pt-5 md:pt-20 flex flex-wrap">
      <div class="md:w-1/2 md:order-first order-last flex flex-col gap-8">
      ...
      <div class="md:w-1/2 mx-auto w-full md:order-last order-first">
        <img class="md:ml-auto ml-[-10px]" src="/assets/images/site/banner.png" alt="">
      </div>
    </div>
  </div>
</template>